...
const Boost: React.FC = () => {
    ...
    const handleVerifyPayment = async (pitchId: string) => {
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    {paymentDetails && (
                        <div className="glass p-6 rounded-2xl mb-8 border-brand-accent/30 bg-brand-accent/5">
                            ...
                            <div className="flex gap-4">
                                <Button 
                                    variant="primary" 
                                    onClick={() => handleSubmitPayment(paymentDetails.payment_details.internal_id)}
                    ...
                    {pendingTxid && (
                        <div className="glass p-6 rounded-2xl mb-8 border-yellow-500/30 bg-yellow-500/5">
                            ...
                            <Button 
                                variant="primary"
                                onClick={() => handleVerifyPayment(paymentDetails?.payment_details.internal_id || '')}
                                disabled={isProcessing}
                            >
                                {isProcessing ? <Loader2 className="animate-spin mr-2" size={18} /> : null}
                                Verify Payment
